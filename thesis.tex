...
\begin{figure}[H]
  ...
  \begin{rules}
    \defrule[empty][sig-empty]{}{
      \Sigma \vdash \cdot \textbf{ sig}
    }
    \qquad
    \defrule[typedef][sig-join]{
      \Sigma \vdash \Sigma' \textbf{ sig} \\ \Sigma \vdash A \textbf{ type}
    }{
      \Sigma \vdash \Sigma', t = A \textbf{ sig}
    }\\
    \defrule[procdef][sig-object]{
      \Sigma \vdash \Sigma' \textbf{ sig} \\ \Sigma \vdash P(x_1,x_2,\ldots,x_n,y_1,y_2,\ldots,y_m) \textbf{ proc}
    }{
      \Sigma \vdash \Sigma', p (y_1, y_2, \ldots, y_m) [x_1, x_2, \ldots, x_n] = P \textbf{ sig}
    }
  \end{rules}
...
\begin{figure}[H]
  ...
  \begin{rules}
    \defrule[call][call]{
      \Sigma \vdash p (y_1, y_2, \ldots, y_m) [x_1, x_2, \ldots, x_n] = P \textbf{ sig} \\
